...
/* Contains values and required settings for common COTS drive modules. */
public class COTSFalconDriveConstants {
    ...
    public COTSFalconDriveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, double angleKF, boolean driveMotorInvert, boolean angleMotorInvert, boolean canCoderInvert) {
    ...
    /**
     * Drive Drive Specialties - MK3 Module
     */
    public static COTSFalconDriveConstants SDSMK3(double driveGearRatio) {
        ...
        return new COTSFalconDriveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, angleKF, driveMotorInvert, angleMotorInvert, canCoderInvert);
    }

    /**
     * Drive Drive Specialties - MK4 Module
     */
    public static COTSFalconDriveConstants SDSMK4(double driveGearRatio) {
        double wheelDiameter = Units.inchesToMeters(4.0);
     ...
     */
    public static COTSFalconDriveConstants SDSMK4i(double driveGearRatio) {
        double wheelDiameter = Units.inchesToMeters(4.0);
